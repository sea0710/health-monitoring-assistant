...
import { PlusIcon, ChevronRightIcon, FileTextIcon, BookOpenIcon, BellIcon } from 'lucide-react';
              ...
              <div className="divide-y divide-border">
                {reports.map((report, index) => (
                  <div
                    ...
                    className="report-item p-4 cursor-pointer"
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <ChevronRightIcon className="w-5 h-5 text-muted-foreground/40 ml-2 shrink-0" />
                    </div>
                  </div>
                ))}
              </div>
